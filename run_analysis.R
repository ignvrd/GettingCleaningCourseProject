...
#Base path for reading the files
#Defining a variables with the base path where our data is placed.
filebasepath_ <- "/Users/nemesis/ProjectCleaningData/UCI_HAR_DataSet/" 
...
write.table(final_sum_out,file=paste0(filebasepath_,"output.txt"),row.name=FALSE)
